...
public class ContactMessageController {
	...
	public ResponseEntity<VRResponse> createMessage(@Valid @RequestBody ContactMessageRequest contactMessageRequest) {
		...
		VRResponse response = new VRResponse(ResponseMessage.CONTACTMESSAGE_CREATED_RESPONSE, true);
	...
	public ResponseEntity<VRResponse> deleteContactMessage(@PathVariable ("id") Long id ){
		...
		VRResponse response=new VRResponse(ResponseMessage.CONTACTMESSAGE_DELETED_RESPONSE,true);
	...
	VRResponse response=new VRResponse(ResponseMessage.CONTACTMESSAGE_UPDATED_RESPONSE,true);
